...
namespace Raylib
{
    ...
    public static partial class Raylib
    {
        ...
        [DllImport(nativeLibName,CallingConvention = CallingConvention.Cdecl)]
        public static extern bool GuiTextBox(Rectangle bounds, [MarshalAs(UnmanagedType.LPStr)] string text, int textSize, bool freeEdit);                   
        
        // Text Box control with multiple lines
        [DllImport(nativeLibName,CallingConvention = CallingConvention.Cdecl)]
        public static extern bool GuiTextBoxMulti(Rectangle bounds, [MarshalAs(UnmanagedType.LPTStr)] string text, int textSize, bool editMode);          
        ...
        [DllImport(nativeLibName,CallingConvention = CallingConvention.Cdecl)]
		//[DllImport(nativeLibName, EntryPoint = "GuiListView")]
		//[return: MarshalAs(UnmanagedType.I1)]
		//public static extern bool GuiListView(Rectangle bounds, [In()] [MarshalAs(UnmanagedType.LPStr)] string text, ref int count, ref int active);
		//public static extern bool GuiListView(Rectangle bounds, IntPtr text, IntPtr active, IntPtr scrollIndex, bool editMode);
		[return: MarshalAs(UnmanagedType.I1)]
		public static extern bool GuiListView(Rectangle bounds, [MarshalAs(UnmanagedType.LPStr)] string text, ref int active, ref int scrollIndex, [MarshalAs(UnmanagedType.I1)] bool editMode);
